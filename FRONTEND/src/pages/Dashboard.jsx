            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200">
                  ...
                  <h2 className="text-4xl font-bold mt-2 text-gray-900">{user?.appliedJobsCount ?? `-`}</h2>
                </div>

                <div className="bg-white rounded-xl p-6 border border-gray-200">
                  <p className="text-gray-500 text-sm">Favorite jobs</p>
                  <h2 className="text-4xl font-bold mt-2 text-gray-900">{user?.favoriteJobsCount ?? `-`}</h2>
                </div>

                <div className="bg-white rounded-xl p-6 border border-gray-200">
                  <p className="text-gray-500 text-sm">Job Alerts</p>
                  <h2 className="text-4xl font-bold mt-2 text-gray-900">{user?.jobAlertsCount ?? `-`}</h2>
                </div>
              </div>
