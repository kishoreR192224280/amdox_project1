  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="bg-teal-600 py-6">
        <div className="text-2xl px-6 md:px-10 text-white font-semibold">
          Welcome to
          <span className="text-amber-400 px-2">AMDOX TECHNOLOGIES</span>
          job opportunities website
          <span className="text-lg md:text-xl float-right text-white">English</span>
        </div>
      </div>
      ...
      <div className="bg-white py-4 px-6 flex justify-end items-center gap-5 border-b">
        ...
        <button className="btn btn-outline btn-primary px-3 flex items-center gap-2">
          <i className="fa-solid fa-user"></i> Sign up
        </button>

        <button className="btn btn-outline btn-primary px-3 flex items-center gap-2">
          <i className="fa-solid fa-circle-check"></i> Log In
        </button>

        <a className="text-primary text-lg font-medium cursor-pointer hover:underline">
          Post Job
        </a>
      </div>
      ...
      <section className="relative w-full min-h-[75vh] flex items-start pt-20">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight">
            Start Your <span className="text-blue-400">Dream Career.</span>
          </h1>
          ...
          {/* ICON STATISTICS */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mt-10 text-center">

            {/* Live Jobs */}
            <div className="flex flex-col items-center">
              <div className="border-4 border-teal-500 rounded-xl w-20 h-20 rotate-45 flex items-center justify-center bg-white/10 backdrop-blur">
                <img src="/image/Livejob.svg" className="w-10 h-10 -rotate-45" />
              </div>
              <p className="text-xl font-semibold text-white mt-2">Live Jobs</p>
              <p className="text-2xl font-bold text-teal-300">600</p>
            </div>

            {/* Companies */}
            <div className="flex flex-col items-center">
              <div className="border-4 border-teal-500 rounded-xl w-20 h-20 rotate-45 flex items-center justify-center bg-white/10 backdrop-blur">
                <img src="/image/Building.svg" className="w-10 h-10 -rotate-45" />
              </div>
              <p className="text-xl font-semibold text-white mt-2">Companies</p>
              <p className="text-2xl font-bold text-teal-300">25+</p>
            </div>

            {/* Candidates */}
            <div className="flex flex-col items-center">
              <div className="border-4 border-teal-500 rounded-xl w-20 h-20 rotate-45 flex items-center justify-center bg-white/10 backdrop-blur">
                <img src="/image/search.svg" className="w-10 h-10 -rotate-45" />
              </div>
              <p className="text-xl font-semibold text-white mt-2">Candidates</p>
              <p className="text-2xl font-bold text-teal-300">700</p>
            </div>

            {/* New Jobs */}
            <div className="flex flex-col items-center">
              <div className="border-4 border-teal-500 rounded-xl w-20 h-20 rotate-45 flex items-center justify-center bg-white/10 backdrop-blur">
                <img src="/image/job.svg" className="w-10 h-10 -rotate-45" />
              </div>
              <p className="text-xl font-semibold text-white mt-2">New Jobs</p>
              <p className="text-2xl font-bold text-teal-300">20+</p>
            </div>
          </div>

          {/* SEARCH BAR — EXACT LIKE IMAGE */}
          <div className="mt-14 bg-white rounded-2xl shadow-lg max-w-4xl mx-auto p-5">

            <div className="flex flex-col md:flex-row items-center gap-4">

              {/* Input 1 */}
              <div className="flex items-center bg-gray-100 rounded-full px-6 py-3 flex-1 border border-gray-200">
                <img src="/image/search.svg" className="w-6 h-6 opacity-50" />
                <input
                  type="text"
                  placeholder="Job title / Skills / Company"
                  className="ml-3 bg-transparent outline-none text-gray-700 w-full placeholder-gray-500"
                />
              </div>

              {/* Input 2 */}
              <div className="flex items-center bg-gray-100 rounded-full px-6 py-3 flex-1 border border-gray-200">
                <img src="/image/Location.svg" className="w-6 h-6 opacity-50" />
                <input
                  type="text"
              ...
              {/* Search Button */}
              <button className="bg-blue-500 text-white rounded-full px-8 py-3 text-lg font-semibold hover:bg-blue-600 transition">
                Search
              </button>
            </div>
      ...
      <section className="py-20 px-6 md:px-10">
        ...
        <div className="flex justify-between items-start">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-black">
              Trending Jobs <span className="text-blue-500">Category</span>
            </h2>
        ...
        <div className="relative mt-12">
          ...
          <button
            onClick={() => {
              document
                .getElementById("trendingScroll")
                .scrollBy({ left: -300, behavior: "smooth" });
            }}
            className="absolute left-3 top-1/2 -translate-y-1/2 bg-white shadow-lg w-10 h-10
               rounded-full flex items-center justify-center border hover:bg-gray-100 transition z-30"
          >
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 bg-white shadow-lg w-10 h-10
               rounded-full flex items-center justify-center border hover:bg-gray-100 transition z-30"
          >
            <span className="text-2xl text-gray-600">{'>'}</span>
          </button>
        ...
        <div className="flex justify-center mt-6">
          <div className="h-[3px] w-24 bg-blue-400 rounded-full"></div>
          <div className="h-[3px] w-12 bg-gray-300 ml-2 rounded-full"></div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#ffffff] py-28">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold mb-20">
            ...
            <span className="text-[#0A4BA0]">Well Option</span>
          ...
          <div className="relative flex flex-col md:flex-row justify-between items-center gap-20 md:gap-10">
            ...
            {/* STEP 2 — CENTER CARD */}
            <div className="bg-white rounded-3xl p-12 shadow-xl max-w-xs text-center z-10">
            ...
            {/* RIGHT CURVED ARROW */}
            <img src="/image/downarrow.svg" className="hidden md:block absolute right-[37%] top-[35%] w-64 opacity-80-translate-y-1/2" />
            <img src="/image/uparrow.svg" className=" hidden md:block absolute right-[11%] top-[10%] w-64 opacity-80-translate-y-1/2" />
            {/* STEP 3 */}
            <div className="flex flex-col items-center max-w-xs">
              <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center">
