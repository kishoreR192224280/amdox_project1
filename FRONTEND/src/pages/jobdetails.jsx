            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="flex gap-6 mt-3 text-sm text-gray-600">
                  <a className="flex item-center justify-center gap-2 text-blue-600 hover:underline">
                    <img src='../image/link.svg' />
                    https://instagram.com
                  </a>
                  <span className="flex item-center gap-2">
                    <img src='../image/phone.svg' />(406) 555-0120</span>
                  <span className="flex item-center gap-2">
                    <img src='../image/mail.svg' />
                    career@instagram.com</span>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white p-8  ">
            ...
            <ul className="mt-4  text-gray-500">
              {[
                ...
                "Conduct user research, interviews, and usability testing to gather insights.",
                "Create wireframes, prototypes, and interactive mockups using tools like Figma, Adobe XD, or Sketch.",
                " Develop and maintain user personas, journey maps, and UX documentation.",
                "Collaborate with cross-functional teams to align business goals with user needs.",
                "Ensure accessibility and usability best practices are followed.",
                "Stay updated with the latest design trends, tools, and industry standards.",
              ].map((item, i) => (
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <div className=" flex gap-4">
                <button className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-sm text-blue-600 font-medium hover:bg-gray-50 transition">
                  <img src="../image/facebook.svg" className="w-4 h-4" />Facebook</button>
                <button className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-sm text-blue-600 font-medium hover:bg-gray-50 transition">
                  <img src="../image/twitter.svg" className="w-4 h-4" />Twitter</button>
                <button className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-sm text-blue-600 font-medium hover:bg-gray-50 transition">
                  <img src="../image/pinterest.svg" className="w-4 h-4" />Pinterest</button>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow">
              <h3 className="text-xl text-black font-semibold mb-4">Job Overview</h3>

              <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-sm">
                <Overview icon="../image/calendar.svg" label="Job Posted" value="14 Jan, 2025" />
                <Overview icon="../image/expire.svg" label="Job Expire In" value="30 Mar, 2025" />
                <Overview icon="../image/Livejob.svg" label="Education" value="Graduation" />
                <Overview icon="../image/purse.svg" label="Salary" value="$50k–80k/month" />
                <Overview icon="../image/map.svg" label="Location" value="New York, USA" />
                <Overview icon="../image/Livejob.svg" label="Job Type" value="Full Time" />
                <Overview icon="../image/Livejob.svg" label="Experience" value="10–15 Years" />
              </div>
            </div>
            ...
            <div className="bg-white text-gray-300 p-6 rounded-2xl border border-gray-100">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                />
                <div>
                  <h3 className="text-xl font-semibold text-black">Instagram</h3>
                  <p className="text-sm text-gray-400">Social networking service</p>
                </div>
              </div>
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-black">March 21, 2006</span>
                </div>

                <div className="flex justify-between">
                  <span className="text-gray-400">Organization type:</span>
                  <span className="text-black">Private Company</span>
                </div>

                <div className="flex justify-between">
                  <span className="text-gray-400">Company size:</span>
                  <span className="text-black">120–300 Employers</span>
                </div>

                <div className="flex justify-between">
                  <span className="text-gray-400">Phone:</span>
                  <span className="text-black">(406) 555-0120</span>
                </div>

                <div className="flex justify-between">
                  <span className="text-gray-400">Email:</span>
                  <span className="text-black">twitter@gmail.com</span>
                </div>

                <div className="flex justify-between">
                  <span className="text-gray-400">Website:</span>
                  <span className="text-black">https://twitter.com</span>
                </div>
              ...
              <div className="flex gap-4 mt-6">
                <button className="group w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center hover:bg-blue-600 transition">
                  <img
                ...
                <button className="group w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center hover:bg-blue-700 transition">
                  <img src="../image/twitter.svg" className="w-5 h-5 transition duration-300 group-hover:invert" />
                </button>

                <button className=" group w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center hover:bg-blue-600 transition">
                  <img src="../image/insta.svg" className="w-5 h-5 transition duration-300 group-hover:invert" />
                </button>

                <button className="group w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center hover:bg-blue-600 transition">
                  <img src="../image/youtube.svg" className="w-5 h-5 transition duration-300 group-hover:invert" />
                </button>
              </div>
